...
export async function fetchFullText(identifier: string): Promise<string> {
  try {
    ...
    console.error("Error fetching Archive.org book text:", error);
    return "Failed to load full text.";
  }
}
